...
class CoinDetailViewModel @Inject constructor(
    ...
    // bundle that contains info about saved state
    // used to restore from process death and navigation params
    savedStateHandle: SavedStateHandle
) : ViewModel() {

    // mutable and immutable state.
    // only viewmodel should be able to modify this
    ...
    private fun getCoin(coinId: String) {
        ...
        // because you overrided operator function invoke()
        ...
        }.launchIn(viewModelScope) // because its a flow and flows are asynchronous.
    }
}